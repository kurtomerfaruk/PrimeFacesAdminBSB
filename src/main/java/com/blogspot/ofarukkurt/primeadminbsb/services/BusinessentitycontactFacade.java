 ...
 * @Created on date 10/08/2017 19:56:24 
 * @blog https://ofarukkurt.blogspot.com.tr/
 * @mail kurtomerfaruk@gmail.com
 */
@Stateless
public class BusinessentitycontactFacade extends AbstractFacade<Businessentitycontact> {
    ...
    public BusinessentitycontactFacade() {
