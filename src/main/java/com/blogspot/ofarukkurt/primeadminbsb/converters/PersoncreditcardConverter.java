...
import com.blogspot.ofarukkurt.primeadminbsb.services.PersoncreditcardFacade;
...
public class PersoncreditcardConverter implements Converter {
    ...
    com.blogspot.ofarukkurt.primeadminbsb.models.PersoncreditcardPK getKey(String value) {
        com.blogspot.ofarukkurt.primeadminbsb.models.PersoncreditcardPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.blogspot.ofarukkurt.primeadminbsb.models.PersoncreditcardPK();
            key.setBusinessEntityID(Integer.parseInt(values[0]));
            key.setCreditCardID(Integer.parseInt(values[1]));
        return key;
    }

    String getStringKey(com.blogspot.ofarukkurt.primeadminbsb.models.PersoncreditcardPK value) {
