...
public class PrimeExceptionHandler extends ExceptionHandlerWrapper {
    ...
    protected ExceptionInfo createExceptionInfo(Throwable rootCause) throws IOException {
        ...
        String strs=info.getFormattedStackTrace().split("<br/>")[1];
        strs=strs.substring(3);
        
        
        info.setFirstRowException(strs);
    ...
    /**
     * Finds the proper {@link AjaxExceptionHandler} for the given
     * {@link Throwable}.
     *
    ...
    /**
     * Builds the view if not already available. This is mostly required for
     * ViewExpiredException's.
     *
     * @param context The {@link FacesContext}.
