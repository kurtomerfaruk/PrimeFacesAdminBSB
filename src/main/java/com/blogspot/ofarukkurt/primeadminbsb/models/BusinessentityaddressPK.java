...
public class BusinessentityaddressPK implements Serializable {
    ...
    public String toString() {
        return "com.blogspot.ofarukkurt.primeadminbsb.models.BusinessentityaddressPK[ businessEntityID=" + businessEntityID + ", addressID=" + addressID + ", addressTypeID=" + addressTypeID + " ]";
    }
