...
public class ProductmodelproductdescriptionculturePK implements Serializable {
    ...
    public String toString() {
        return "com.kurtomerfaruk.primeadminbsb.models.ProductmodelproductdescriptionculturePK[ productModelID=" + productModelID + ", productDescriptionID=" + productDescriptionID + ", cultureID=" + cultureID + " ]";
    }
