...
public class PersonphonePK implements Serializable {
    ...
    public String toString() {
        return "com.kurtomerfaruk.primeadminbsb.models.PersonphonePK[ businessEntityID=" + businessEntityID + ", phoneNumber=" + phoneNumber + ", phoneNumberTypeID=" + phoneNumberTypeID + " ]";
    }
