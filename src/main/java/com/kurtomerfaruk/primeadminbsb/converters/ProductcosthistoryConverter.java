...
import com.kurtomerfaruk.primeadminbsb.services.ProductcosthistoryFacade;
...
public class ProductcosthistoryConverter implements Converter {
    ...
    com.kurtomerfaruk.primeadminbsb.models.ProductcosthistoryPK getKey(String value) {
        com.kurtomerfaruk.primeadminbsb.models.ProductcosthistoryPK key;
        String values[] = value.split(SEPARATOR_ESCAPED);
        key = new com.kurtomerfaruk.primeadminbsb.models.ProductcosthistoryPK();
        key.setProductID(Integer.parseInt(values[0]));
        key.setStartDate(java.sql.Date.valueOf(values[1]));
        return key;
    }

    String getStringKey(com.kurtomerfaruk.primeadminbsb.models.ProductcosthistoryPK value) {
