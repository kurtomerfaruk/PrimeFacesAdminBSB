...
import com.kurtomerfaruk.primeadminbsb.services.ProductlistpricehistoryFacade;
...
public class ProductlistpricehistoryConverter implements Converter {
    ...
    com.kurtomerfaruk.primeadminbsb.models.ProductlistpricehistoryPK getKey(String value) {
        com.kurtomerfaruk.primeadminbsb.models.ProductlistpricehistoryPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.kurtomerfaruk.primeadminbsb.models.ProductlistpricehistoryPK();
            key.setProductID(Integer.parseInt(values[0]));
            key.setStartDate(java.sql.Date.valueOf(values[1]));
        return key;
    }

    String getStringKey(com.kurtomerfaruk.primeadminbsb.models.ProductlistpricehistoryPK value) {
