...
import com.kurtomerfaruk.primeadminbsb.models.Emailaddress;
import com.kurtomerfaruk.primeadminbsb.services.EmailaddressFacade;
...
public class EmailaddressConverter implements Converter {
    ...
    com.kurtomerfaruk.primeadminbsb.models.EmailaddressPK getKey(String value) {
        com.kurtomerfaruk.primeadminbsb.models.EmailaddressPK key;
        String values[] = value.split(SEPARATOR_ESCAPED);
        key = new com.kurtomerfaruk.primeadminbsb.models.EmailaddressPK();
        key.setBusinessEntityID(Integer.parseInt(values[0]));
        key.setEmailAddressID(Integer.parseInt(values[1]));
        return key;
    }

    String getStringKey(com.kurtomerfaruk.primeadminbsb.models.EmailaddressPK value) {
